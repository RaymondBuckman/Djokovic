            ...
            <div className="Serve-1">
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <h2 id="serve-secondary-header" className="text-center">Free points for me only</h2>
                    </div>
                </div>
            </div>
